    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        <label className="block text-sm font-medium text-zinc-700">
          Username <span className="text-green-700">*</span>
        </label>
        ...
        <div className="relative mt-2">
          ...
          <input
            ...
            className={`w-full rounded-xl border py-3 pl-7 pr-4 text-zinc-900 placeholder:text-zinc-400 bg-white focus:outline-none focus:ring-2 focus:ring-green-700 transition-colors ${
              usernameHint ? 'border-red-400' : 'border-zinc-200'
            }`}
          />
        </div>
        {usernameHint && (
      ...
      <div>
        ...
        <input
          ...
          className="mt-2 w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-700"
        />
      </div>
      ...
      <button
        ...
        className="w-full rounded-xl px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
